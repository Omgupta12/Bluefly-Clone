  ...
  return (
    <>
          ...
          <SimpleGrid columns={[1,null,3]}>
            {footer_arr.map((e) => {
              return (
                  ...
                  <Container w="100%" p="5" mt="5" mb="5">
                    <Image w="100%" h="300" src={e.imgurl} />
                    <Center>
                      <Text mt="2" fontSize={'2xl'}>{e.title}</Text>
                    </Center>
                    <Center>
     ...
     <Box
      ...
      <Container maxW={'full'} py={10} border={'1px solid red'}>
        <SimpleGrid border={'1px solid red'}
          columns={[ 1,null,3 ]}
          spacing={8}>
       

          <Stack align={'flex-start'} justifyContent={'space-between'} flexDirection={'row'} border={'1px solid red'}>
           <Stack>
           <Center><ListHeader align={'center'}>ABOUT US</ListHeader></Center>
            <Link href={'#'}>Contact us</Link>
            <Link href={'#'}>Frequently Asked Questions</Link>
            <Link href={'#'}>Shipping & Returns</Link>
            <Link href={'#'}>Pre-Ownes Guide</Link>
